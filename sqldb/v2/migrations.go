...
type MigrationStream struct {
	...
	// MakeMigrationTasks is a function that returns a map of code
	// migrations that will be executed after the corresponding SQL
	...
	// SQL migration.
	MakeMigrationTasks func(*BaseDB) (map[uint]migrate.MigrationTask, error)

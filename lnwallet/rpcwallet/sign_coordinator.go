...
func (s *SignCoordinator) handshake(stream StreamServer) error {
	var (
		registerChan     = make(chan *remotesignerrpc.SignerRegistration)
	...
	go func() {
		...
		case *remotesignerrpc.SignCoordinatorResponse_SignerRegistration:
			select {
	...
	req := &remotesignerrpc.SignCoordinatorRequest_RegistrationResponse{
...
func (s *SignCoordinator) getResponse(ctx context.Context,
	...
	case resp, ok := <-respChan:
		...
		type sErr = remotesignerrpc.SignCoordinatorResponse_SignerError
...
func (s *SignCoordinator) Ping(ctx context.Context,
	...
	req := &remotesignerrpc.SignCoordinatorRequest_Ping{
		Ping: true,
	}
	...
	return processRequest(
		ctxt, s,
		func(reqId uint64) remotesignerrpc.SignCoordinatorRequest {
			return remotesignerrpc.SignCoordinatorRequest{
				RequestId:       reqId,
				SignRequestType: req,
			}
		},
...
func (s *SignCoordinator) DeriveSharedKey(ctx context.Context,
	...
	req := &remotesignerrpc.SignCoordinatorRequest_SharedKeyRequest{
		SharedKeyRequest: in,
	}
...
func (s *SignCoordinator) MuSig2Cleanup(ctx context.Context,
	...
	req := &remotesignerrpc.SignCoordinatorRequest_MuSig2CleanupRequest{
...
func (s *SignCoordinator) MuSig2CombineSig(ctx context.Context,
	...
	req := &remotesignerrpc.SignCoordinatorRequest_MuSig2CombineSigRequest{
...
func (s *SignCoordinator) MuSig2CreateSession(ctx context.Context,
	...
	req := &remotesignerrpc.SignCoordinatorRequest_MuSig2SessionRequest{
...
func (s *SignCoordinator) MuSig2RegisterNonces(ctx context.Context,
	...
	req := &remotesignerrpc.SignCoordinatorRequest_MuSig2RegisterNoncesRequest{
...
func (s *SignCoordinator) MuSig2RegisterCombinedNonce(ctx context.Context,
	...
	req := &remotesignerrpc.SignCoordinatorRequest_MuSig2CombinedNoncesReq{
...
func (s *SignCoordinator) MuSig2GetCombinedNonce(ctx context.Context,
	...
	req := &remotesignerrpc.SignCoordinatorRequest_MuSig2GetCombinedNoncesReq{
...
func (s *SignCoordinator) MuSig2Sign(ctx context.Context,
	...
	req := &remotesignerrpc.SignCoordinatorRequest_MuSig2SignRequest{
...
func (s *SignCoordinator) SignMessage(ctx context.Context,
	...
	req := &remotesignerrpc.SignCoordinatorRequest_SignMessageReq{
		SignMessageReq: in,
	}
...
func (s *SignCoordinator) SignPsbt(ctx context.Context,
	...
	req := &remotesignerrpc.SignCoordinatorRequest_SignPsbtRequest{
		SignPsbtRequest: in,
	}

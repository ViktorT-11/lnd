...
func (d *RPCSignerWalletImpl) BuildChainControl(
	...
	var inboundRemoteSignerConn rpcwallet.InboundRemoteSignerConnection
	if conn, ok := remoteSignerConn.(rpcwallet.
		InboundRemoteSignerConnection); ok {

		inboundRemoteSignerConn = conn
	}
